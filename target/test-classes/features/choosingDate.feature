...
Feature:US_014_Date creation
  ...
  Scenario: TC_001 Date create for account positive
    ...
    And Click on the Create Date input box and enter the "account creation date"
      | Create Date || 11/15/2020 12:00 AM     |
    And Click on the Closed Date input box and enter the  "<account closing date>" as later than the time of "<account creating date>"
      | Create Date | 11/15/2020 12:00 AM  |
      |  Closed Date  | 12/15/2020 12:00 AM    |
