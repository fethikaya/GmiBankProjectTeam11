...
public class UserInfoUpdateStepDefinitions {
    ...
    //    Driver.waitAndClick(userInfoPage.userInfoSelect,3);
    ...
    public void user_assert_that_there_is_no_option_other_than_English_and_Turkish() {
        for (WebElement w:languageOptions) {
            Assert.assertTrue("user can only select English or Turkish",
                    w.getText().equals("Türkçe")||w.getText().equals("English"));
        }
    }
