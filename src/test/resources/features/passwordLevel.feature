...
Feature:
  ...
  @TC_Valid_03
  Scenario Outline: There should be at least 1 Uppercase
  char for stronger password and see
  ...
  @TC_004
  Scenario Outline: There should be at least 1 lower case
  char for stronger password and see
  the level chart change accordingly
